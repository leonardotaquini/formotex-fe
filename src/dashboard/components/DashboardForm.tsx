...
export const DashboardForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    const formattedValues = {
      ...values,
      acquisition: new Date(values.acquisition).toISOString(), // Convertir a formato ISO completo
    };
    ...
    <DashboardPage>
      <Form {...form}>
        <form
          ...
          className="gap-y-2 gap-x-2 grid grid-cols-12 shadow p-4 border rounded"
        >
          <FormField
